...
import com.example.Plantify.adapters.viewpager.HomeViewpagerAdapter
import com.example.Plantify.databinding.FragmentHomeBinding
import com.example.Plantify.fragments.categories.*
import com.example.Plantify.fragments.categories.Plant2Fragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TabLayoutMediator(binding.tabLayout,binding.viewpagerHome){tab,position->
            ...
            when(position){
                ...
                1-> tab.text = "PlantCat1"
                2-> tab.text = "PlantCat2"
                3-> tab.text = "PlantCat3"
                4-> tab.text = "PlantCat4"
                5-> tab.text = "PlantCat5"
                6-> tab.text = resources.getText(R.string.g_accessory)
            }
