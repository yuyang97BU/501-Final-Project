package com.example.Plantify.firebaseDatabase

import android.util.Log
import com.example.Plantify.model.*
import com.example.Plantify.util.Constants.Companion.ADDRESS_COLLECTION
import com.example.Plantify.util.Constants.Companion.BEST_DEALS
import com.example.Plantify.util.Constants.Companion.CART_COLLECTION
import com.example.Plantify.util.Constants.Companion.CATEGORIES_COLLECTION
import com.example.Plantify.util.Constants.Companion.CATEGORY
import com.example.Plantify.util.Constants.Companion.CLOTHES
import com.example.Plantify.util.Constants.Companion.COLOR
import com.example.Plantify.util.Constants.Companion.CUPBOARD_CATEGORY
import com.example.Plantify.util.Constants.Companion.ID
import com.example.Plantify.util.Constants.Companion.ORDERS
import com.example.Plantify.util.Constants.Companion.ORDER_PLACED_STATE
import com.example.Plantify.util.Constants.Companion.PRICE
import com.example.Plantify.util.Constants.Companion.PRODUCTS_COLLECTION
import com.example.Plantify.util.Constants.Companion.QUANTITY
import com.example.Plantify.util.Constants.Companion.SIZE
import com.example.Plantify.util.Constants.Companion.STORES_COLLECTION
import com.example.Plantify.util.Constants.Companion.TITLE
import com.example.Plantify.util.Constants.Companion.USERS_COLLECTION
